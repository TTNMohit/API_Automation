...
public class ContentList {
    ...
    @SerializedName("taContentId")
    @Expose
    private String taContentId;
    ...
    public String getTaContentId() {
        return taContentId;
    }

    public void setTaContentId(String taContentId) {
        this.taContentId = taContentId;
    }
